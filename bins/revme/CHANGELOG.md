...
## [7.2.0](https://github.com/leruaa/revm/compare/revme-v7.1.0...revme-v7.2.0) - 2025-08-06
...
- *(benches)* rename anaysis-inspector to snailtracer-inspect ([#2834](https://github.com/leruaa/revm/pull/2834))
...
- add gas_limit to revme evm ([#2779](https://github.com/leruaa/revm/pull/2779))
# Changelog
All notable changes to this project will be documented in this file.
