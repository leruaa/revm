...
## [10.0.0](https://github.com/leruaa/revm/compare/revm-context-interface-v9.0.0...revm-context-interface-v10.0.0) - 2025-08-06
...
- swapped comments for db and db_mut methods in JournalTr trait ([#2774](https://github.com/leruaa/revm/pull/2774))

### Other

- rm redundant lifetime constraints ([#2850](https://github.com/leruaa/revm/pull/2850))
