...
## [17.0.0-alpha.7](https://github.com/leruaa/revm/compare/revm-precompile-v17.0.0-alpha.6...revm-precompile-v17.0.0-alpha.7) - 2025-03-19

### Added

- bls special case G1/G2_MUL ([#2248](https://github.com/leruaa/revm/pull/2248))
- Remove PrecompileError from PrecompileProvider ([#2233](https://github.com/leruaa/revm/pull/2233))

### Other

- add invariant test for G1/G2 Mul ([#2247](https://github.com/leruaa/revm/pull/2247))
- add documentation for the gas related constants for EIP2537 ([#2246](https://github.com/leruaa/revm/pull/2246))
- add a safe blst wrapper ([#2223](https://github.com/leruaa/revm/pull/2223))
- Remove redundant bls12-381 constants and cleanup naming ([#2235](https://github.com/leruaa/revm/pull/2235))
- Add some documentation for the bls12-381 precompile constants ([#2222](https://github.com/leruaa/revm/pull/2222))
