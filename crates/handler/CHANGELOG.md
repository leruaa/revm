...
## [9.0.0](https://github.com/leruaa/revm/compare/revm-handler-v8.1.0...revm-handler-v9.0.0) - 2025-08-06
...
- rm commented code ([#2839](https://github.com/leruaa/revm/pull/2839))
- *(benches)* clean up criterion callsites ([#2833](https://github.com/leruaa/revm/pull/2833))
- improve ExtBytecode hash handling ([#2826](https://github.com/leruaa/revm/pull/2826))
- fix run-tests.sh ([#2801](https://github.com/leruaa/revm/pull/2801))
